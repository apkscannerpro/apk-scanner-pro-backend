...
app.config["MAX_CONTENT_LENGTH"] = 150 * 1024 * 1024  # 150MB max APK size
...
def subscribe():
    ...
    # store subscribers later in DB if needed
...
def handle_413(e): return jsonify({"error": "File too large. Max 150MB."}), 413
